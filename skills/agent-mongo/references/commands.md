...
- `agent-mongo credential login <name> [--connection <alias>]` — complete a --device login; prints the code and URL as a {"notice": ...} on stderr. --connection only needed when several connections use the credential
